...
namespace arpc
{
    ...
    public:
        ...
        void reset_timer(task_t task)
        {
            ...
            {
                task->timer.expires_from_now(boost::posix_time::milliseconds(n));
        ...
        void do_resolve(task_t task)
        {
            ...
            resolver.async_resolve(c->host(), c->port(),
            [task, self = shared_this()](error_code_t ec, results_type endpoints)
            {
                self->on_resolve(task, ec, endpoints);
            });
        }
        ...
        void do_connect(task_t task, results_type endpoints)
        {
            ...
            [task, self = shared_this()](error_code_t ec, endpoint_t)
            {
        ...
        void do_write(task_t task)
        {
            ...
            count = sizeof(arpc::header) + rpc_len + arg_len;
    ...
    public:
        ...
        channel(net::io_context& ioc) : ioc(ioc)
        {
        }
